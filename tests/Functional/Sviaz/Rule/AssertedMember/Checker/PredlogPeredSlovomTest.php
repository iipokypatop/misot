...
class PredlogPeredSlovomTest extends \AotTest\AotDataStorage
{
    public function testExecuteReturns_TRUE()
    {
        ...
        /** @var  $predlog \Aot\RussianMorphology\ChastiRechi\Predlog */
        $predlog = $this->getSafeMock(\Aot\RussianMorphology\ChastiRechi\Predlog::class);
    ...
    public function testExecuteReturns_FALSE()
    {
        ...
        /** @var  $Soyuz \Aot\RussianMorphology\ChastiRechi\Soyuz */
        $Soyuz = $this->getSafeMock(\Aot\RussianMorphology\ChastiRechi\Soyuz::class);
