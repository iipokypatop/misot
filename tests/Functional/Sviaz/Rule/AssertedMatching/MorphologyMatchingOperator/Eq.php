 ...
 * Time: 13:00
 */
class Eq extends \AotTest\AotDataStorage
{
    ...
    public function testMatch_Return_True_Left_And_Right_Params_Has_Equals_Class()
    {
        $operator_eq = \Aot\Sviaz\Rule\AssertedMatching\MorphologyMatchingOperator\Eq::create();
    ...
    public function testMatch_Return_True_Left_Params_Is_Null()
    {
        $operator_eq = \Aot\Sviaz\Rule\AssertedMatching\MorphologyMatchingOperator\Eq::create();
    ...
    public function testMatch_Return_True_Right_Params_Is_Null()
    {
        $operator_eq = \Aot\Sviaz\Rule\AssertedMatching\MorphologyMatchingOperator\Eq::create();
    ...
    public function testMatch_Returns_False()
    {
        ...
        $memberbase = \Aot\Sviaz\Rule\AssertedMatching\MorphologyMatchingOperator\Eq::create();
        $this->assertEquals(false, $memberbase->match($left, $right));
    }
